    ...
    return MasalPage(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Beğenilen masallar.',
            style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: AppColors.textBase.withOpacity(0.85)),
          ),
                        ...
                        child: Padding(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    s.content.length > 70 ? '${s.content.substring(0, 70)}...' : s.content,
                            ...
                            FavoriteHeartButton(
                              ...
                              onToggle: () {
                                ref.read(libraryControllerProvider.notifier).toggleFavorite(
                                      storyId: s.storyId,
                            ...
                            SizedBox(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () => context.go('/story_player/${s.storyId}'),
                              ),
                            ),
                          ],
                          ),
